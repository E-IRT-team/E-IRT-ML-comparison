...
##-----------------------------------------------------------------------------
# empirical setting
p_grid = {'min_samples_leaf': [1, 2, 5], 'max_features': ["sqrt"], 'n_estimators': [200]}
##-----------------------------------------------------------------------------
##-----------------------------------------------------------------------------
outer_folds = 10
inner_folds = 3
...
#        inner_cv_scores = np.zeros([outer_folds])
        ...
        RFClassifier,clname = RandomForestRegressor(),"RF"
        ...
        for train, test in scenarios[group]:  # KFold.split is a generator object, outputs 2 ndarrays
            ...
            clf = GridSearchCV(estimator=RFClassifier, param_grid=p_grid, 
...
#            clf = RandomForestRegressor(200,max_features="sqrt")
          
         
            ypred = clf.predict(Xtotest)
